...
# my config
########################################################################################################################
EMA_TIME = 10   # 5 min half life
RET_TIME = 2.5  # 2.5 min return
SIZE_MUL = 0.1  # 0.12 of total available position
RESET_TIME = 1000
# if spread too small, no trade will happen at all
MAXVOL = 0.003
MINVOL = 0.0003
PX_LIST  = [0.75,    1  ,   1.5,   2,   5]
